...
class SberPayApi {
  ...
  Future<bool> initSberPay(InitConfig config) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.initSberPay$__pigeon_messageChannelSuffix';
  ...
  Future<bool> isReadyForSPaySdk() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.isReadyForSPaySdk$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
  ...
  Future<SberPayApiPaymentStatus> payWithBankInvoiceId(PayConfig config) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.sber_pay_ios.SberPayApi.payWithBankInvoiceId$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
